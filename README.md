...
- **[SaveState](https://github.com/savestatedev/savestate)** - Encrypted portable memory for AI agents. Snapshots that survive the chat for Cursor, Claude Code, and Clawdbot.
